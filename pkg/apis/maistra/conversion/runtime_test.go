...
func runtimeTestCasesV2(version versions.Version) []conversionTestCase {
	...
	return []conversionTestCase{
		...
		{
			name: "defaults.poddisruption.1." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
		...
		{
			name: "defaults.poddisruption.2." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Defaults: &v2.DefaultRuntimeConfig{
		...
		{
			name: "citadel.deployment.autoscale." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "galley.deployment.autoscale." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "pilot.deployment.autoscale." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "mixer.policy.runtime.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "mixer.policy.runtime.basic." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "mixer.policy.runtime.autoscale." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "mixer.runtime.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "mixer.runtime.autoscale." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "jaeger.runtime.images." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
		...
		{
			name: "jaeger.elasticsearch.runtime.full." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Runtime: &v2.ControlPlaneRuntimeConfig{
					Components: map[v2.ControlPlaneComponentName]*v2.ComponentRuntimeConfig{
