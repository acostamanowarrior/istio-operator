...
func grafanaTestCasesV2(version versions.Version) []conversionTestCase{
	...
	return []conversionTestCase{
		...
		{
			name: "install.persistence.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Addons: &v2.AddonsConfig{
					Grafana: &v2.GrafanaAddonConfig{
		...
		{
			name: "install.persistence.simple." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Addons: &v2.AddonsConfig{
					Grafana: &v2.GrafanaAddonConfig{
		...
		{
			name: "install.persistence.resources.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Addons: &v2.AddonsConfig{
					Grafana: &v2.GrafanaAddonConfig{
		...
		{
			name: "install.persistence.resources.values." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Addons: &v2.AddonsConfig{
					Grafana: &v2.GrafanaAddonConfig{
		...
		{
			name: "install.security.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Addons: &v2.AddonsConfig{
					Grafana: &v2.GrafanaAddonConfig{
		...
		{
			name: "install.security.full." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Addons: &v2.AddonsConfig{
					Grafana: &v2.GrafanaAddonConfig{
