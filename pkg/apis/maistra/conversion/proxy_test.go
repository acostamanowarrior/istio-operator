...
func proxyTestCasesV2(version versions.Version) []conversionTestCase {
	...
	return []conversionTestCase{
		...
		{
			name: "networking.init.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.init.init.default." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.init.init.runtime." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.protocol.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.protocol.auto.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.protocol.auto.all." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.defaults." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.inbound.redirect." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.inbound.tproxy." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.inbound.ports." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.inbound.ports.empty." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.outbound.policy.any." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.outbound.policy.registry." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.outbound.ports." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
		...
		{
			name: "networking.traffic.outbound.ports.empty." + ver,
			spec: &v2.ControlPlaneSpec{
				Version: ver,
				Proxy: &v2.ProxyConfig{
					Networking: &v2.ProxyNetworkingConfig{
