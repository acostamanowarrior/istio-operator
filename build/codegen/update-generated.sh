...
deepcopy \
github.com/acostamanowarrior/istio-operator/pkg/generated \
...
go run -mod=vendor k8s.io/code-generator/cmd/deepcopy-gen \
    -i github.com/acostamanowarrior/istio-operator/pkg/apis/maistra/status \
    --go-header-file "./build/codegen/boilerplate.go.txt" \
    -O zz_generated.deepcopy

go run --mod=vendor k8s.io/code-generator/cmd/conversion-gen \
    -i ./pkg/apis/maistra/conversion \
    -p github.com/acostamanowarrior/istio-operator/pkg/maistra/conversion \
    --go-header-file "./build/codegen/boilerplate.go.txt" \
...
bash vendor/k8s.io/code-generator/generate-groups.sh \
    deepcopy \
    github.com/acostamanowarrior/istio-operator/pkg/generated \
    github.com/acostamanowarrior/istio-operator/pkg/apis/external/istio \
